...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        self.bn1 = B.MyBatchNorm2d(in_planes)
        self.conv1 = C.MyConv2dNB(in_planes, 4*growth_rate, kernel_size=1, bias=False)
        self.bn2 = B.MyBatchNorm2d(4*growth_rate)
        self.conv2 = C.MyConv2dNB(4*growth_rate, growth_rate, kernel_size=3, padding=1, bias=False)
...
class Transition(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.bn = B.MyBatchNorm2d(in_planes)
        self.conv = C.MyConv2dNB(in_planes, out_planes, kernel_size=1, bias=False)
...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10):
        ...
        self.conv1 = C.MyConv2dNB(3, num_planes, kernel_size=3, padding=1, bias=False)
        ...
        self.bn = B.MyBatchNorm2d(num_planes)
        self.linear = L.MyLinear(num_planes, num_classes)
