...
lepoch=[0 for i in range(num_gpus)] 
lbatch_idx=[ 0 for i in range(num_gpus)]
llayer= [ 0 for i  in range(num_gpus)]
llayer2= [ 0 for i in range(num_gpus)]
...
class mylinear(Function):
    ...
    def backward(self, dy):
        ...
        #print("LINEAR WEIGHT", wt_per)
        #print("LINEAR INPUT" , in_per)
